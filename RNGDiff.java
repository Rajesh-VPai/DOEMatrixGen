...
public class RNGDiff {
    ...
    public static void main(String... args) {
        ...
        log.fatal("RNGDiffTest:main:Speed is better if we comment all log.info in MathsContxtLAv  OR log4j.rootLogger=OFF in log properties File!!!");
