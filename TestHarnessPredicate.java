 ...
 */
public class TestHarnessPredicate {
    public static Logger log = Logger.getLogger(TestHarnessPredicate.class.getName());
    ...
    /* ************** == , != , && , || Test Cases  * */
        ...
        UsageCalculus.UserTestPredicate = "( (x^2+y^2) >= 100 )";
        ...
        UsageCalculus.UserTestPredicate = "( (x==2)&& (y==2) )";
        UsageCalculus.TestCaseName = "Simple: Coefficients:0.0";
        UsageCalculus.TestCaseMatrixID="Coefficients:0.0:1 Letter:* Operator:No Exponent Sign:Constant End:Term Sign +&-";
}
        ...
        UsageCalculus.TestCaseName = "Simple: Coefficients:0.0";
        UsageCalculus.TestCaseMatrixID="Coefficients:0.0:1 Letter:* Operator:No Exponent Sign:Constant End:Term Sign +&-";
        // Result(Logical Value)=Unknown @x==2, y==2
}
        ...
        public static void TestCase226() {
        //Test Case 226
        UsageCalculus.TestCase = 226;
        UsageCalculus.UserTestPredicate = "((x^2+y^2 < 900) && ( y==(x+1)) )";
        UsageCalculus.TestCaseName = "Simple: State Transition:";
        UsageCalculus.TestCaseMatrixID="Coefficients:0.0:1 Letter:* Operator:No Exponent Sign:Constant End:Term Sign +&-";
        // Result(Logical Value)=Unknown @x==2, y==2
}
        public static void TestCase227() {
        //Test Case 227
        UsageCalculus.TestCase = 227;
        UsageCalculus.UserTestPredicate = "((x%4==2)&&(y%4==2) )";
        UsageCalculus.TestCaseName = "Simple: State Transition:";
        UsageCalculus.TestCaseMatrixID="Coefficients:0.0:1 Letter:* Operator:No Exponent Sign:Constant End:Term Sign +&-";
        // Result(Logical Value)=Unknown @x==2, y==2
}
